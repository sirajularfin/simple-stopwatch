...
const LocalizationProvider: React.FC<LocalizationWrapperProps> = ({ children, initialLocale }) => {
	...
	const contextValue = useMemo(() => ({ locale, toggleLanguage }), [locale, toggleLanguage]);
